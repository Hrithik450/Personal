...
New-Item -ItemType Directory -Path "config","controllers","middlewares","models","routes","services","utils" | Out-Null
New-Item -ItemType File -Path "config/config.env" | Out-Null
New-Item -ItemType File -Path "controllers/authController.js","controllers/productController.js","controllers/orderController.js","controllers/adminController.js" | Out-Null
...
New-Item -ItemType File -Path "models/User.js","models/Product.js","models/Order.js" | Out-Null
New-Item -ItemType File -Path "routes/authRoutes.js","routes/productRoutes.js","routes/orderRoutes.js","routes/adminRoutes.js" | Out-Null
New-Item -ItemType File -Path "services/emailService.js","services/paymentService.js" | Out-Null
