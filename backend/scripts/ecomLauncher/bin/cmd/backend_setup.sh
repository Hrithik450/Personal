...
touch controllers/{authController.js,productController.js,orderController.js,adminController.js}
touch middlewares/{authMiddleware.js,errorHandler.js,catchAsyncError.js}
touch models/{User.js,Product.js,Order.js}
touch routes/{authRoutes.js,productRoutes.js,orderRoutes.js,adminRoutes.js}
touch services/{emailService.js,paymentService.js}
