...
mkdir -p {components/admin,components/auth,components/cart,components/common,components/home,components/layout,components/product}
mkdir -p {hooks,pages/{Admin,Auth,Cart,Checkout,Home,Product,NotFound},routes,store/slices/{address,admin/adminAuth,admin/adminOrder,admin/adminProduct,cart,auth,order,products},utils}

touch routes/{adminRoute.jsx,appRoute.jsx,index.jsx,privateRoute.jsx}

touch store/slices/admin/adminAuth/{adminAuthSlice.jsx,adminAuthThunks.jsx}
touch store/slices/admin/adminOrder/{adminOrderSlice.jsx,adminOrderThunks.jsx}
touch store/slices/admin/adminProduct/{adminProductSlice.jsx,adminProductThunks.jsx}

touch store/slices/address/{addressSlice.jsx,addressThunks.jsx}
touch store/slices/cart/{cartSlice.jsx,cartThunks.jsx}
touch store/slices/auth/{authSlice.jsx,authThunks.jsx}
touch store/slices/order/{orderSlice.jsx,orderThunks.jsx}
touch store/slices/products/{productSlice.jsx,productThunks.jsx}
