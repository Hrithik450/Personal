...
New-Item -ItemType Directory -Path "src/components/admin","src/components/auth","src/components/cart","src/components/common","src/components/home","src/components/layout","src/components/product" | Out-Null
New-Item -ItemType Directory -Path "src/hooks","src/pages/Admin","src/pages/Auth","src/pages/Cart","src/pages/Checkout","src/pages/Home","src/pages/Product","src/pages/NotFound","src/routes","src/store/slices/address","src/store/slices/admin/adminAuth","src/store/slices/admin/adminOrder","src/store/slices/admin/adminProduct","src/store/slices/cart","src/store/slices/auth","src/store/slices/order","src/store/slices/products","src/utils" | Out-Null
New-Item -ItemType File -Path "src/store/slices/address/addressSlice.jsx","src/store/slices/address/addressThunks.jsx","src/store/slices/admin/adminAuth/adminAuthSlice.jsx","src/store/slices/admin/adminAuth/adminAuthThunks.jsx","src/store/slices/admin/adminOrder/adminOrderSlice.jsx","src/store/slices/admin/adminOrder/adminOrderThunks.jsx","src/store/slices/admin/adminProduct/adminProductSlice.jsx","src/store/slices/admin/adminProduct/adminProductThunks.jsx","src/store/slices/cart/cartSlice.jsx","src/store/slices/cart/cartThunks.jsx","src/store/slices/auth/authSlice.jsx","src/store/slices/auth/authThunks.jsx","src/store/slices/order/orderSlice.jsx","src/store/slices/order/orderThunks.jsx","src/store/slices/products/productSlice.jsx","src/store/slices/products/productThunks.jsx" | Out-Null
