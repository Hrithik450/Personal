...
declare global {
    var app: <T extends string | null | any = null>(abstract?: T | string | null, params?: any) => T extends null ? Application : T;
    ...
    var abort: (code: number, message?: string, headers?: ObjectOf<string>) => void;
